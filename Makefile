...
APPNAME=psoc6_pioneer_template
...
CY_COMPILER_GCC_ARM_DIR?=$(HOME)/Applications/mtb-gcc-arm-eabi/14.2.1/gcc
...
CY_TOOLS_PATHS+=$(HOME)/Applications/ModusToolbox/tools_3.8
